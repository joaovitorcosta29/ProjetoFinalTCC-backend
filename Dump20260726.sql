...
CREATE TABLE `tb_veiculos` (
  ...
  `status` enum('DISPONIVEL','EM_USO','EM_MANUTENÇÃO') COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'DISPONIVEL',
...
INSERT INTO `tb_veiculos` VALUES (1,'AZA1D23','Marcopolo Torino',2014,180000,85000,'DISPONIVEL'),(2,'AUZ9K87','Marcopolo Torino',2025,22000,NULL,'DISPONIVEL');
...
-- Dump completed on 2026-07-26 16:12:09
