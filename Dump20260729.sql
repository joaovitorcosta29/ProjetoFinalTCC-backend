...
CREATE TABLE `tb_usuario` (
  ...
  `cargo` enum('MOTORISTA','ADMIN','GESTOR_FROTA') NOT NULL DEFAULT 'MOTORISTA',
...
CREATE TABLE `tb_veiculos` (
  ...
  `status` enum('DISPONIVEL','EM_USO','MANUTENCAO','DESATIVADO') NOT NULL,
...
INSERT INTO `tb_veiculos` VALUES (1,'AZA1D23','Marcopolo Torino',2014,180000,85000,'DESATIVADO'),(2,'AUZ9K87','Marcopolo Torino',2025,22000,NULL,'DISPONIVEL'),(3,'AUZ-3168','Marcopolo Torino',2026,0,0,'DISPONIVEL'),(6,'ASA-0921','Marcopolo Torino',2020,500000,450000,'EM_USO'),(7,'PHP','Marcopolo Torino',2026,0,0,'DISPONIVEL');
...
CREATE TABLE `tb_viagens` (
  `id_viagem` bigint(20) NOT NULL AUTO_INCREMENT,
  `id_usuario` int(11) DEFAULT NULL,
  `id_veiculo` int(11) NOT NULL,
  `cidade_destino` varchar(255) DEFAULT NULL,
  `km_inicial` double DEFAULT NULL,
  `km_final` double DEFAULT NULL,
  `status_viagem` enum('DISPONIVEL','EM_ANDAMENTO','FINALIZADA') NOT NULL DEFAULT 'DISPONIVEL',
...
INSERT INTO `tb_viagens` VALUES (1,2,1,'Fábrica Centro-Oeste',1500,2200,'FINALIZADA','OK',NULL),(2,NULL,1,'asdsad',NULL,NULL,'DISPONIVEL','OK','AM'),(3,NULL,6,'Ibiporã',500000,NULL,'EM_ANDAMENTO','OK','PR');
...
-- Dump completed on 2026-07-29 17:09:22
